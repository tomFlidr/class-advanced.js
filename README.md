...
[![Latest Stable Version](https://img.shields.io/badge/stable-2.0.1-green.svg)](https://github.com/tomFlidr/class.js/releases)
...
* [**download class.dev.js (for development with JSDocs comments for IDE)**](https://tomflidr.github.io/class.js/builds/2.0.1/class.dev.js)
* [**download class.min.js (for production)**](https://tomflidr.github.io/class.js/builds/2.0.1/class.min.js)

```html
<!-- for production: -->
<script type="text/javascript" src="https://tomflidr.github.io/class.js/builds/2.0.1/class.min.js"></script>

<!-- for development with JSDocs comments for IDE: -->
<script type="text/javascript" src="https://tomflidr.github.io/class.js/builds/2.0.1/class.dev.js"></script>
```
