...
*/
var Class=function(h){function a(){var b=a.c(arguments);if("string"==typeof b[0])return a.u(b[0],1<b.length?b[1]:{});b=a.s(b[0],"Class");b[a.a.Namespace]="";b[a.a.Fullname]="Class";return b}if("undefined"!=typeof h.Class)return h.Class;Function.prototype.bind||(Function.prototype.bind=function(a){function d(){return g.apply(this instanceof c?this:a,e.concat(f.call(arguments)))}function c(){}if("function"!==typeof this)throw new TypeError("Function.prototype.bind - what is trying to be bound is not callable");
...
(b[a.a.GetInstanceUid](),a.j(b).prototype[d]):function(){return a.h(b,d,a.c(arguments),0)}};a.H=function(b){var d=a.a.Name,c=a.a.parent,f="",e=b[a.a.Extend];b[c]=function(){return a.h(this,arguments.callee.caller[d],a.c(arguments),1)};c=b[c];if(e)for(f in e)"function"!=typeof e[f]||a.b[f]||(c[f]=a.I(b,f))};a.I=function(b,d){return a.f?(b[a.a.GetClassUid](),a.j(b)[d]):function(){return a.h(b,d,a.c(arguments),1)}};a.h=function(b,d,c,f){var e=a.a.Fullname,g=a.a.self,k=a.a["static"],l=b[k],h=l[a.a.Extend],
m;if(!h)throw"No parent class defined for type: '"+l[e]+"'.";m=f?h[d]:h.prototype[d];if(!(m instanceof Function))throw"No parent method named: '"+d+"' for type: '"+l[e]+"'.";b[g]=h;d=m.apply(f?b[a.a[k]]:b,c);b[g]=l;return d};a.j=function(b){b=b[a.a.self];var d=b[a.a.Extend];if(!d)throw"No parent class defined for type: '"+b[a.a.Fullname]+"'.";return d};a.c=function(b){return 1===b.length&&a.M(b[0])?[].slice.apply(b[0]):[].slice.apply(b)};a.M=function(a){return"object"==typeof a&&"undefined"!=typeof a.callee&&
"[object Array]"!=Object.prototype.toString.apply(a)};return h.Class=a}("undefined"!==typeof module&&module.exports?global:this);
